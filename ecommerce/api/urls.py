...
from .views import ProductView,CartView,CartItemView,OrderViewSet,OrderItemViewSet,ReviewViewSet
...
router.register(f'orders',OrderViewSet,basename='orders')
router.register(r'order-items', OrderItemViewSet, basename='orderitem')
router.register(f'reviews',ReviewViewSet,basename='reviews')
